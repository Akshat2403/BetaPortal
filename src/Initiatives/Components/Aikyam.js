        ...
        <div>
            ...
            <div className={styles.bodypart}>
                ...
                <div className={styles.rightpart}>
                    <div style={{height:'20vw',width:'46vw',overflow:'hidden',borderTopRightRadius:'5vw',borderBottomLeftRadius:'5vw'}}>

                    <img src={pic1}  alt="" />
                    </div>
                    <div style={{display:'flex'}}>
                        <div style={{height:'15vw',width:'23vw',overflow:'hidden',borderTopRightRadius:'5vw',borderBottomLeftRadius:'5vw',marginTop:'2vw',marginRight:'1vw'}}>

                    <img src={pic2} style={{}} alt="" />
                        </div>
                        <div style={{height:'15vw',width:'22vw',marginTop:'2vw',marginLeft:'1vw',overflow:'hidden',borderTopRightRadius:'5vw',borderBottomLeftRadius:'5vw'}}>
                ...
                <div className={styles.bgdclass}>
                    ...
                    <div className={styles.rectgreen}>
