...
useEffect(() => {
    ...
    >
      ...
      >
        ...
        <img src={animebgd} alt="Your Image" />
            ...
            <Button width='12vw'  backgroundColor={bgdcolor1} className={styles.b1}  >Aikyam</Button>
            <Button width='14vw'  backgroundColor={bgdcolor2} className={styles.b2}  >Manshakti</Button>
            <Button width='12vw'  backgroundColor={bgdcolor3} className={styles.b3}  >Safher</Button>

                </div>
                <div className={styles.row2}>
                <Button width='14vw'  backgroundColor={bgdcolor4} className={styles.b4}  >Prithvi</Button>
            <Button width='30vw'  backgroundColor={bgdcolor5} className={styles.b5}  >North-East Unvield</Button>
            <Button width='12vw'  backgroundColor={bgdcolor6} className={styles.b6}  >Udaan</Button>
                </div>
                 </div>
                 <div id='anim' className={styles.animate}>
  <div  className={styles.first}>
    <div id='anim' className={`${styles.animationElement} ${isHovered ? styles.paused : ''}`}
  ...
  <div  className={styles.second}><div id='anim1'  className={`${styles.animationElement} ${isHovered ? styles.paused : ''}`}
        onMouseEnter={() => handleHover(true)}
        onMouseLeave={() => handleHover(false)}><Aikyam>MANSHAKTI</Aikyam></div></div>
  <div className={styles.third}><div id='anim2'  className={`${styles.animationElement} ${isHovered ? styles.paused : ''}`}
        onMouseEnter={() => handleHover(true)}
        onMouseLeave={() => handleHover(false)}><Aikyam>SAFHER</Aikyam></div></div>
  <div className={styles.fourth}><div id='anim3' className={`${styles.animationElement} ${isHovered ? styles.paused : ''}`}
        onMouseEnter={() => handleHover(true)}
        onMouseLeave={() => handleHover(false)}><Aikyam>PRITHVI</Aikyam></div></div>
  <div className={styles.fifth}><div id='anim4' className={`${styles.animationElement} ${isHovered ? styles.paused : ''}`}
        onMouseEnter={() => handleHover(true)}
        onMouseLeave={() => handleHover(false)}><Aikyam>NORTH-EAST UNVIELD</Aikyam></div></div>
  <div className={styles.sixth}><div id='anim5' className={`${styles.animationElement} ${isHovered ? styles.paused : ''}`}
        onMouseEnter={() => handleHover(true)}
        onMouseLeave={() => handleHover(false)}><Aikyam>UDAAN</Aikyam></div></div>
</div>
